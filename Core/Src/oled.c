 ...
 * @param color 颜色
 */
void OLED_PrintASCIIChar(int8_t x, int8_t y, char ch, const ASCIIFont *font, OLED_ColorMode color)
{
 ...
 * @param color 颜色
 */
void OLED_PrintASCIIString(int8_t x, int8_t y, char *str, const ASCIIFont *font, OLED_ColorMode color)
{
  int8_t x0 = x;
  while (*str)
  {
